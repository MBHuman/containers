...
LABEL com.vmware.cp.artifact.flavor="sha256:c50c90cfd9d12b445b011e6ad529f1ad3daea45c26d20b00732fae3cd71f6a83" \
      ...
      org.opencontainers.image.created="2024-05-14T00:04:23Z" \
      ...
      org.opencontainers.image.ref.name="3.5.1-debian-12-r6" \
...
RUN mkdir -p /tmp/bitnami/pkg/cache/ ; cd /tmp/bitnami/pkg/cache/ ; \
    COMPONENTS=( \
      "python-3.12.3-1-linux-${OS_ARCH}-debian-12" \
      "java-17.0.11-10-1-linux-${OS_ARCH}-debian-12" \
      "spark-3.5.1-1-linux-${OS_ARCH}-debian-12" \
    ) ; \
